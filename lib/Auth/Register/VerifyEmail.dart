                      ...
                      child:     Form(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Enter verification code here', style: TextStyle(height:1, color: wesYellow, fontSize: 12, fontFamily: 'Montserrat'),),
                              SizedBox(
                                height: 20,
                              ),
                              ...
                              Text('Resend email verification', style: TextStyle(height:1, color: wesYellow, fontSize: 12, fontFamily: 'Montserrat'),),
